...
#         add_image(elements, stacked_mult, width = 450, height = 230)
    ...
    obs_desc = obs_desc[~obs_desc['Key'].isin(['leiden', 'leiden_R', 'general_celltype', 'general_CL_ID', 'celltype', 'CL_ID', 'subtype'])]
